...
dy[p1_y-2:p1_y+2] = conv.m_in(0.0055)
dy[p1_y-3] = conv.m_in(0.01)
dy[p1_y+2] = conv.m_in(0.01)
dz[4:] = conv.m_in(0.02)
# dy[p1_y-2] = conv.m_in(0.005)
...
z = conv.z_gamma(S11)
fig, ax = plt.subplots()
ax.plot(frequency/1e9, z, alpha=0.3)
...
p = s.generate_gif("msline_2.gif", el=0, zoom=2, vmin=-40, vmax=30, az=0, view="xy", volume=False)
# p.show()
